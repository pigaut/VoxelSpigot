...
public class ConditionalFunction implements Function {
    ...
    private final FunctionAction success;
    private final FunctionAction failure;

    public ConditionalFunction(String name, String group, Condition condition, FunctionAction success, FunctionAction failure) {
        this.name = name;
        this.group = group;
    ...
    @Override
    public FunctionResponse dispatch(@Nullable PlayerState player, @Nullable Event event,
