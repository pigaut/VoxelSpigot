...
public class PathGroup {
    ...
    public static File getFile(EnhancedPlugin plugin, String parent, String group, String file) {
        final String groupPath = String.join(File.separator, StringFormatter.splitWords(group));
    ...
    public static File getFile(EnhancedPlugin plugin, String parent, String group) {
        final String groupPath = String.join(File.separator, StringFormatter.splitWords(group)) + ".yml";
