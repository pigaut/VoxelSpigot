...
// Modified by Pigaut on 12/09/2025
public class Reflection {
     ...
     */
    public static Reflection compile(String name, String content) throws ReflectException {
     ...
     * @throws ReflectException if anything went wrong compiling the class.
     */
    public static Reflection compile(String name, String content, CompileOptions options) throws ReflectException {
     ...
     */
    @Deprecated
    public static Reflection on(String name) throws ReflectException {
        return onClass(name);
    }
     ...
     */
    @Deprecated
    public static Reflection on(String name, ClassLoader classLoader) throws ReflectException {
     ...
     * @see #onClass(Class)
     */
    public static Reflection onClass(String name) throws ReflectException {
     ...
     * @see #onClass(Class)
     */
    public static Reflection onClass(String name, ClassLoader classLoader) throws ReflectException {
     ...
     * @return A wrapped class object, to be used for further reflection.
     */
    public static Reflection onClass(Class<?> clazz) {
     ...
     */
    public static Reflection on(Object object) {
        return new Reflection(object == null ? Object.class : object.getClass(), object);
    }

    private static Reflection on(Class<?> type, Object object) {
     ...
     * @throws ReflectException If any reflection exception occurred.
     */
    public Reflection set(String name, Object value) throws ReflectException {
        try {
     ...
     * @throws ReflectException If any reflection exception occurred.
     */
    public Reflection call(String name, Object... args) throws ReflectException {
     ...
     * @see #create(Object...)
     */
    public Reflection create() throws ReflectException {
    ...
    // Created by Pigaut on 14/09/2025
    public boolean matchConstructor(@NotNull Class<?>... parameterTypes) {
        try {
    ...
    // Created by Pigaut on 14/09/2025
    public boolean matchMethod(@NotNull String name, @NotNull Class<?>... parameterTypes) {
        try {
            ...
            for (Method method : type().getDeclaredMethods()) {
                if (method.getName().equals(name) &&
                        match(method.getParameterTypes(), parameterTypes)) {
                    return true;
                }
            }
    ...
    public boolean isMethodOverridden(String methodName, Class<?>... paramTypes) {
        try {
            Method method = type().getDeclaredMethod(methodName, paramTypes);
            Class<?> declaringClass = method.getDeclaringClass();

            Method superMethod = type().getSuperclass().getDeclaredMethod(methodName, paramTypes);
            return !declaringClass.equals(superMethod.getDeclaringClass());
        } catch (NoSuchMethodException e) {
            return false;
        }
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Reflection) {
            return object.equals(((Reflection) obj).get());
        }
     ...
     */
    private static Reflection on(Constructor<?> constructor, Object... args) throws ReflectException {
        try {
     ...
     */
    private static Reflection on(Method method, Object object, Object... args) throws ReflectException {
        try {
            accessible(method);
